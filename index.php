...
<script>
    ...
    document.getElementById('x2').addEventListener('change', function() {
        if (this.checked) {
            document.getElementById('gambleButton').textContent = '1/2';
        }
    });

    document.getElementById('bet100').addEventListener('change', function() {
        if (this.checked) {
            document.getElementById('gambleButton').textContent = '100';
        }
    });

    document.getElementById('bet1000').addEventListener('change', function() {
        if (this.checked) {
            document.getElementById('gambleButton').textContent = '1000';
        }
    });

    document.getElementById('allIn').addEventListener('change', function() {
        if (this.checked) {
            document.getElementById('gambleButton').textContent = 'All IN';
        }
    });
